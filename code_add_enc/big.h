...
public:
    Big(){MR_INIT_BIG} Big(int j) { MR_INIT_BIG convert(j, fn); }
    ...
    Big(mr_dltype dl)
    {
        MR_INIT_BIG dlconv(dl, fn);
    }
#endif
#else
    Big(long lg)
    {
        MR_INIT_BIG lgconv(lg, fn);
    }
#endif
    Big(char *s)
    {
        MR_INIT_BIG cinstr(fn, s);
    }
    ...
    /*--------------------------------------------------------------�Լ����ӵ������ϵ�ģ�Ӻ���-------------------------------------------------------------------*/
    //nres_modadd(x,y,z)
    friend Big modadd(const Big &, const Big &, const Big &);
    //{Big z; nres_modadd(b1.fn,b2.fn,z.fn); return z;}
    /*--------------------------------------------------------------�Լ����ӵ������ϵ�ģ�Ӻ���-------------------------------------------------------------------*/
    /*--------------------------------------------------------------�Լ����ӵ������ϵ�ģ������-------------------------------------------------------------------*/
    //nres_modsub(x,y,z)
    friend Big modsub(const Big &, const Big &, const Big &);
