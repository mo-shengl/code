...
/*--------------------------------------------------------------�Լ����ӵ�ZZn2��Ԫ��ת��Ϊ�ַ����ĺ���-------------------------------------------------------------------*/
//void get_char_g2(const ZZn2& gid,const char *id)
//{
...
//nres_modadd(x,y,z)
BOOL ZZn2_compare(const ZZn2& x,const ZZn2& y)
{
...
{
    ZZn2 w;
    zzn2_from_zzns(randn().getzzn(), randn().getzzn(), &w.fn);
    return w;
}
#endif
