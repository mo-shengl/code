...
public:
    ZZn2(){MR_INIT_ZZN2 MR_ZERO_ZZN2} ZZn2(int w) { MR_INIT_ZZN2 if (w == 0) MR_ZERO_ZZN2 else zzn2_from_int(w, &fn); }
    ZZn2(int w, int z) { MR_INIT_ZZN2 zzn2_from_ints(w, z, &fn); }
    ZZn2(const ZZn2 &w){MR_INIT_ZZN2 MR_CLONE_ZZN2(w)} ZZn2(const Big &x, const Big &y) { MR_INIT_ZZN2 zzn2_from_bigs(x.getbig(), y.getbig(), &fn); }
    ...
    void clear(){MR_ZERO_ZZN2} BOOL iszero() const { return zzn2_iszero((zzn2 *)&fn); }
    ...
    {
        if (i == 0)
            MR_ZERO_ZZN2 else zzn2_from_int(i, &fn);
        return *this;
    }
    ZZn2 &operator=(const ZZn &x)
    {
        zzn2_from_zzn(x.getzzn(), &fn);
        return *this;
    }
    ZZn2 &operator=(const ZZn2 &x) { MR_CLONE_ZZN2(x)
                                     return *this; }
    ZZn2 &operator+=(const ZZn &x)
    {
        zzn2_sadd(&fn, x.getzzn(), &fn);
        return *this;
    }
    ZZn2 &operator+=(const ZZn2 &x)
    {
        zzn2_add(&fn, (zzn2 *)&x, &fn);
        return *this;
    }
    ZZn2 &operator-=(const ZZn &x)
    {
        zzn2_ssub(&fn, x.getzzn(), &fn);
        return *this;
    }
    ZZn2 &operator-=(const ZZn2 &x)
    {
        zzn2_sub(&fn, (zzn2 *)&x, &fn);
        return *this;
    }
    ZZn2 &operator*=(const ZZn2 &x)
    {
        zzn2_mul(&fn, (zzn2 *)&x, &fn);
        return *this;
    }
    ZZn2 &operator*=(const ZZn &x)
    {
        zzn2_smul(&fn, x.getzzn(), &fn);
        return *this;
    }
    ZZn2 &operator*=(int x)
    {
    ...
    /*--------------------------------------------------------------�Լ����ӵ�ZZn2��Ԫ���Ƿ���ȵ��жϺ���,�����ˣ���ɾȥ����Ϊzzn2.h�������ж���ȵ����ط�==-------------------------------------------------------------------*/
    //nres_modadd(x,y,z)
    friend BOOL ZZn2_compare(const ZZn2& x,const ZZn2& y);
    //{int t; zzn2_compare(x.fn,y.fn); return t;}
    /*--------------------------------------------------------------�Լ����ӵ�ZZn2��Ԫ���Ƿ���ȵ��жϺ���,�����ˣ���ɾȥ����Ϊzzn2.h�������ж���ȵ����ط�==-------------------------------------------------------------------*/
    ...
    friend BOOL operator==(const ZZn2 &x, const ZZn2 &y) //zzn2.h�������ж���ȵ����ط�==
    {
        if (zzn2_compare((zzn2 *)&x, (zzn2 *)&y))
            return TRUE;
        else
            return FALSE;
    }
